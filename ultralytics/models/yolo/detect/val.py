...
class DetectionValidator(BaseValidator):
    ...
    Examples:
        >>> from ultralytics.models.yolo.visdrone_detect import DetectionValidator
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks=None) -> None:
        ...
        self.is_lvis = False
        self.class_map = None
        self.args.task = "visdrone_detect"
    ...
    def postprocess(self, preds: torch.Tensor) -> list[dict[str, torch.Tensor]]:
        ...
        outputs = nms.non_max_suppression(
            ...
            self.args.conf,
            self.args.iou,
            nc=0 if self.args.task == "visdrone_detect" else self.nc,
            multi_label=True,

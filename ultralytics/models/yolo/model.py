...
class YOLO(Model):
    ...
    Attributes:
        ...
        task: The task type (visdrone_detect, segment, classify, pose, obb).
...
class YOLOWorld(Model):
    ...
    Attributes:
        ...
        task: Always set to 'visdrone_detect' for object detection.
        overrides: Configuration overrides for the model.
    ...
    def __init__(self, model: str | Path = "yolov8s-world.pt", verbose: bool = False) -> None:
        ...
        """
        super().__init__(model=model, task="visdrone_detect", verbose=verbose)
...
class YOLOE(Model):
    ...
    Attributes:
        ...
        task: The task type (visdrone_detect or segment).
        overrides: Configuration overrides for the model.
    ...
    def set_vocab(self, vocab: list[str], names: list[str]) -> None:
        ...
        Args:
            ...
            names (list[str]): List of class names that the model can visdrone_detect or classify.

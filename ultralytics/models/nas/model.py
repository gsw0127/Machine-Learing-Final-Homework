...
class NAS(Model):
    ...
    Attributes:
        ...
        task (str): The task type for the model, defaults to 'visdrone_detect'.
    ...
    def __init__(self, model: str = "yolo_nas_s.pt") -> None:
        ...
        super().__init__(model, task="visdrone_detect")
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        self.model.task = "visdrone_detect"  # for export()
    ...
    def task_map(self) -> dict[str, dict[str, Any]]:
        ...
        return {"visdrone_detect": {"predictor": NASPredictor, "validator": NASValidator}}

...
class AutoBackend(nn.Module):
    ...
    Attributes:
        ...
        task (str): The type of task the model performs (visdrone_detect, segment, classify, pose).
        names (dict): A dictionary of class names that the model can visdrone_detect.

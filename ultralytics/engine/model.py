...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        # Check if Triton Server model
            ...
            self.overrides["task"] = task or "visdrone_detect"  # set `task=visdrone_detect` if not explicitly set
            return
    ...
    def _new(self, cfg: str, task=None, model=None, verbose=False) -> None:
        ...
        Examples:
            >>> model = Model()
            >>> model._new("yolo11n.yaml", task="visdrone_detect", verbose=True)
        """
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        Examples:
            ...
            >>> model._load("path/to/weights.pth", task="visdrone_detect")
        """
    ...
    def _smart_load(self, key: str):
        ...
        Examples:
            >>> model = Model(task="visdrone_detect")
    ...
    def task_map(self) -> dict:
        ...
        This property method returns a dictionary that maps each supported task (e.g., visdrone_detect, segment, classify) to a
        ...
        Examples:
            ...
            >>> detect_predictor = task_map["visdrone_detect"]["predictor"]

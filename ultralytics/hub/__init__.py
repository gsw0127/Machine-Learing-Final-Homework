...
def check_dataset(path: str, task: str) -> None:
    ...
    Args:
        ...
        task (str): Dataset task. Options are 'visdrone_detect', 'segment', 'pose', 'classify', 'obb'.

    Examples:
        >>> from ultralytics.hub import check_dataset
        >>> check_dataset("path/to/coco8.zip", task="visdrone_detect")  # visdrone_detect dataset

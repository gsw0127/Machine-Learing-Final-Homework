...
class AIGym(BaseSolution):
    ...
    Methods:
        process: Process a frame to visdrone_detect poses, calculate angles, and count repetitions.
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Pose model to visdrone_detect keypoints, estimate angles, and count repetitions based on predefined angle thresholds.

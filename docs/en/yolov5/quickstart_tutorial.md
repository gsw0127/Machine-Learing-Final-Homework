...
```bash
python visdrone_detect.py --weights yolov5s.pt --source 0                              # webcam
python visdrone_detect.py --weights yolov5s.pt --source image.jpg                      # image
python visdrone_detect.py --weights yolov5s.pt --source video.mp4                      # video
python visdrone_detect.py --weights yolov5s.pt --source screen                         # screenshot
python visdrone_detect.py --weights yolov5s.pt --source path/                          # directory
python visdrone_detect.py --weights yolov5s.pt --source list.txt                       # list of images
python visdrone_detect.py --weights yolov5s.pt --source list.streams                   # list of streams
python visdrone_detect.py --weights yolov5s.pt --source 'path/*.jpg'                   # glob pattern
python visdrone_detect.py --weights yolov5s.pt --source 'https://youtu.be/LNwODJXcvt4' # YouTube video
python visdrone_detect.py --weights yolov5s.pt --source 'rtsp://example.com/media.mp4' # RTSP, RTMP, HTTP stream
```

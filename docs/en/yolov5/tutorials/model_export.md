...
```bash
python visdrone_detect.py --weights yolov5s.pt             # PyTorch
python visdrone_detect.py --weights yolov5s.torchscript    # TorchScript
python visdrone_detect.py --weights yolov5s.onnx           # ONNX Runtime or OpenCV DNN with dnn=True
python visdrone_detect.py --weights yolov5s_openvino_model # OpenVINO
python visdrone_detect.py --weights yolov5s.engine         # TensorRT
python visdrone_detect.py --weights yolov5s.mlmodel        # CoreML (macOS only)
python visdrone_detect.py --weights yolov5s_saved_model    # TensorFlow SavedModel
python visdrone_detect.py --weights yolov5s.pb             # TensorFlow GraphDef
python visdrone_detect.py --weights yolov5s.tflite         # TensorFlow Lite
python visdrone_detect.py --weights yolov5s_edgetpu.tflite # TensorFlow Edge TPU
python visdrone_detect.py --weights yolov5s_paddle_model   # PaddlePaddle
```
